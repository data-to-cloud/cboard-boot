 ...
 */
public abstract class XlsxProcesser {

    private static int DEFAULT_HEIGHT = 18;

    public BigExcelWriter draw(XlsxProcesserContext context) {
    ...
    protected abstract BigExcelWriter drawContent(XlsxProcesserContext context);
}
